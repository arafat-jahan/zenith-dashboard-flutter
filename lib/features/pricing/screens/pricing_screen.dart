    ...
    return Scaffold(
      ...
      body: plansAsync.when(
        data: (plans) => CustomScrollView(slivers: [
              ...
              child: Column(children: [
                ...
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    _ToggleBtn(
                      label: 'Monthly',
                      isSelected: billing == 'monthly',
                      onTap: () => ref.read(selectedBillingCycleProvider.notifier).state = 'monthly',
                    ),
                    _ToggleBtn(
                      label: 'Annual',
                      isSelected: billing == 'annual',
                      badge: 'Save 17%',
                      onTap: () => ref.read(selectedBillingCycleProvider.notifier).state = 'annual',
                    ),
                  ]),
                ),
              ]),
          ...
          // Mobile: একটা column, Desktop: grid
          isMobile
              ? SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate(
                  ...
                  child: _PricingCard(plan: plans[i], cycle: billing),
                ),
        ...
        error: (err, st) => _PricingError(
          error: err.toString(),
          onRetry: () => ref.invalidate(pricingPlansProvider),
        ),
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: plan.glowColor.withValues(alpha: 0.3),
                    blurRadius: 20,
                  )
                ],
              ),
          ...
          ...plan.features.map((f) => Padding(
            ...
            child: Row(children: [
              Icon(LucideIcons.checkCircle2, size: 16, color: plan.glowColor),
